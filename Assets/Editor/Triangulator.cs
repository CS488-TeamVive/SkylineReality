...
public class Triangulator
{
    ...
    public int[] TriangulatePolygon () {
            int VertexCount = m_points.Count;
            ...
            {
                if (m_points[ii1].x < xmin) { xmin = m_points[ii1].x; }
                else if (m_points[ii1].x > xmax) { xmax = m_points[ii1].x; }
                if (m_points[ii1].y < ymin) { ymin = m_points[ii1].y; }
                else if (m_points[ii1].y > ymax) { ymax = m_points[ii1].y; }
            }
            float dx = xmax - xmin;
            float dy = ymax - ymin;
            ...
            System.Collections.Generic.List<Triangle> TriangleList = new System.Collections.Generic.List<Triangle>();
            TriangleList.Add(new Triangle(VertexCount, VertexCount + 1, VertexCount + 2));
            for (int ii1 = 0; ii1 < VertexCount; ii1++)
            {
                System.Collections.Generic.List<Edge> Edges = new System.Collections.Generic.List<Edge>();
    ...
    public bool TriangulatePolygonSubFunc_InCircle(
