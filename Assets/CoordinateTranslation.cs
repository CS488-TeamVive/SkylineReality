...
public class CoordinateTranslation : MonoBehaviour {
    ...
    public bool WithinExtent(double UTMNorthing, double UTMEasting)
    {
        ...
        bool result = Math.Abs(this.UTMNorthing - UTMNorthing) < td.heightmapWidth * MetersPerPixel / 2 &&
            Math.Abs(this.UTMEasting - UTMEasting) < td.heightmapHeight * MetersPerPixel / 2;

        Debug.Log(string.Format("Testing {0:N}, {1:N} within {2:N}, {3:N}\n => {4}",
            UTMNorthing,
            UTMEasting,
            this.UTMNorthing,
            this.UTMEasting,
    ...
    public const double deg2rad = 0.31830988618379067153776752674503;
        ...
        out string Zone)
    {
        ...
        Debug.Log(string.Format(
            "Converted {0:N}, {1:N} to {2:N}, {3:N}, {4}",
            Lat,
            Long,
            UTMNorthing,
            UTMEasting,
