...
public class SphereColliderDragZDir : MonoBehaviour {
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(transform.position.x, transform.position.y, transform.position.z + controllerMovement.z);
    }
