...
public class SphereColliderDragXDir : MonoBehaviour {
    ...
    void Update()
    {
        ...
        transform.position = new Vector3(transform.position.x + controllerMovement.x, transform.position.y, transform.position.z);
    }
